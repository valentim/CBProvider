...
class __TwigTemplate_61d160096ae0ccd65a12abc4428fafb5b93dc949e016ca963433cfc32d9537ff extends Twig_Template
{
...
<div id=\"sfToolbarMainContent-";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["name"] => $context["template"]) {
            // line 29
            echo "        ";
            echo twig_escape_filter($this->env, $this->getAttribute($context["template"], "renderblock", array(0 => "toolbar", 1 => array("collector" => $this->getAttribute($this->getContext($context, "profile"), "getcollector", array(0 => $context["name"]), "method"), "profiler_url" => $this->getContext($context, "profiler_url"), "token" => $this->getAttribute($this->getContext($context, "profile"), "token", array()), "name" => $context["name"])), "method"), "html", null, true);
            // line 35
            echo "
    ";
        }
